...
export function Alert({ children, onDismiss }: AlertProps) {
	if (onDismiss) {
		return (
			<div
				role="alert"
				className="glass rounded-lg px-4 py-2.5 flex items-center justify-between border-error/20 border"
			>
	...
	return (
		<div
			role="alert"
			className="bg-error/8 border border-error/20 rounded-lg px-4 py-2.5 text-center"
		>
