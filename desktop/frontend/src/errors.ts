...
const errorMap: [RegExp, string][] = [
  ...
  [/pin auth blocked/i, "PIN is blocked. Too many failed attempts. Reset your security key to continue."],
  [/pin policy violation/i, "PIN does not meet requirements (too short or too simple)"],
  [/no FIDO2 device found/i, "Security key not detected. Make sure it's plugged in."],
  ...
  [/does not support hmac-secret/i, "This security key doesn't support hmac-secret. A compatible FIDO2 key is required."],
  [/failed to set hmac salt/i, "Credentials are invalid or corrupted. Re-register your security key."],
  ...
  [/config not found/i, "No configuration found. Register a security key first."],
